          ...
          <div className="space-y-8">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <section>
                ...
                <p className="text-brand-gray-700 mb-4">When you contact us or request services, you may provide:</p>
                ...
                <p className="text-brand-gray-700 mb-4">When you visit our website, we automatically collect:</p>
                <ul className="list-disc pl-6 text-brand-gray-700 mb-6 space-y-1">
                ...
                <p className="text-brand-gray-700 mb-4">We use various tracking technologies, including:</p>
                <ul className="list-disc pl-6 text-brand-gray-700 mb-4 space-y-1">
              ...
              <section>
                ...
                <p className="text-brand-gray-700 mb-4">We share information with trusted companies that help us operate, including:</p>
                <ul className="list-disc pl-6 text-brand-gray-700 mb-6 space-y-1">
              ...
              <section>
                ...
                <p className="text-brand-gray-700 mb-4">If you're in the European Economic Area or UK, we process your data based on:</p>
                <ul className="list-disc pl-6 text-brand-gray-700 mb-4 space-y-1">
              ...
              <section>
                ...
                <p className="text-brand-gray-700 mb-4">Depending on where you live, you may have rights to:</p>
                <ul className="list-disc pl-6 text-brand-gray-700 mb-4 space-y-1">
              ...
              {/* Contact */}
              <section className="bg-brand-gray-50 rounded-lg p-6">
