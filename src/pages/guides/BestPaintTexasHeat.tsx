  ...
  return (
    <>
      ...
      <SplitSection
        ...
        description={<>Our 15+ years of experience with <Link to="/exterior-painting-austin" className="text-brand-azure hover:underline">exterior painting in Austin</Link> has taught us what works and what doesn't in Texas heat. Here's what we recommend for maximum paint performance in Austin's climate.</>}
        benefits={[
