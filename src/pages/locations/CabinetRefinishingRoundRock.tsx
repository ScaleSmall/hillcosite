...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        ...
        "answer": "Full-scope cabinet refinishing in Round Rock typically begins around $6,500 and often ranges from $6,500 to $11,000+ depending on the number of cabinet doors, drawer fronts, box painting, prep needs, and finish expectations. We provide exact pricing after measuring your kitchen."
    },
    {
