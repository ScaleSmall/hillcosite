...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    processSteps: [
      { title: 'Detailed Assessment', description: 'Thorough evaluation of your Leander home\'s exterior condition and sun exposure.' },
      ...
      { title: 'Optimal Scheduling', description: 'Weather-smart timing for Leander\'s variable Hill Country conditions.' },
    ...
    faqs: [
      { question: 'How much does exterior painting cost in Leander?', answer: 'Leander exterior painting typically ranges from $4,200-$11,000 depending on home size, condition, and materials. We provide detailed quotes after assessment.' },
      { question: 'What paint works best for Leander sun exposure?', answer: 'Leander\'s Hill Country location means intense sun. We use premium paints with advanced UV protection and fade resistance for lasting color.' },
      { question: 'How long does Leander exterior painting take?', answer: 'Most Leander exteriors take 3-5 days depending on home size and prep needs. We work efficiently while maintaining quality.' },
      { question: 'Do you paint HardiePlank siding?', answer: 'Yes! Many Leander homes have HardiePlank or similar fiber cement siding. We use appropriate primers and paints for excellent adhesion and longevity.' },
  ...
  images: {
    ...
    secondaryAlt: 'Leander exterior painting quality'
  }
};
