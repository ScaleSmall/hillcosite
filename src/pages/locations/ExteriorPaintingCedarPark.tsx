...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    introText: `Cedar Park homes face unique Hill Country challenges - intense sun exposure, variable terrain, and active family lifestyles. Our exterior painting services address these needs with thorough preparation, premium UV-resistant paints, and efficient execution. Whether you're in Buttercup Creek or Twin Creeks, we deliver protection and beauty that lasts.`,
    benefits: [
