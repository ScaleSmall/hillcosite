...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
      { question: 'How much does interior painting cost in West Lake Highlands?', answer: 'Full-scope West Lake Highlands interior painting typically begins around $7,000 and often ranges from $7,000-$15,500 depending on home size, detail work, ceiling height, prep needs, and finish requirements.' },
