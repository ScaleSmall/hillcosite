...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        ...
        "answer": "Full-scope interior painting in Leander typically begins around $6,250 and often ranges from $6,250 to $10,000+ depending on home size, number of rooms, ceiling height, prep needs, and finish expectations. We provide detailed written estimates after an in-home visit."
    },
    {
