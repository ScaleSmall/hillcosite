...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        "question": "How much does cabinet refinishing cost in Cedar Park?",
        "answer": "Full-scope cabinet refinishing in Cedar Park typically begins around $6,500 and often ranges from $6,500 to $10,500+ depending on the number of cabinet doors, drawer fronts, box painting, prep needs, and finish expectations. We provide exact pricing after measuring your kitchen."
    },
    {
        "question": "How long does cabinet refinishing take in Cedar Park?",
        "answer": "Most Cedar Park kitchen cabinet projects take 3–5 days including prep, spray application, and curing. We use quick-dry professional products that allow recoating within hours, minimizing the time your kitchen is out of service."
    },
    {
    ...
    {
        "question": "What colors are most popular for cabinet refinishing in Cedar Park?",
        "answer": "White and off-white remain the most popular choices in Cedar Park — Benjamin Moore Chantilly Lace, Simply White, and Sherwin-Williams Pure White are consistent top picks. Navy and soft blue-gray are popular for islands. We can match virtually any color."
    },
    {
    ...
    testimonials: [
    {
        ...
        "rating": 5,
        "text": "Hill Country Painting did an excellent job with our cabinet refinishing project in Cedar Park. Professional, reliable, and the results exceeded our expectations.",
        "initials": "AC"
    },
    {
        "name": "B. Homeowner",
  ...
  images: {
    ...
    secondaryAlt: 'Cedar Park cabinet refinishing excellence'
  }
};
