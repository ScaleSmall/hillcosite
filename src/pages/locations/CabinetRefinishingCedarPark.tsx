...
const config: ServiceLocationConfig = {
  ...
  location: location,
  canonicalOverride: '/cabinet-refinishing-cedar-park',
  content: {
    ...
    introText: `Cedar Park families are updating their kitchens with cabinet refinishing - achieving modern looks at a fraction of new cabinet costs. Whether your Avery Ranch kitchen has dated oak or your Twin Creeks cabinets need a color refresh, our team delivers smooth, durable finishes that transform your space while working around your family's schedule.`,
    benefits: [
