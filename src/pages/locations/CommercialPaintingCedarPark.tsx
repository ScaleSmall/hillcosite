...
const config: ServiceLocationConfig = {
  ...
  location: location,
  content: {
    heroSubtitle: "Commercial painting services in Cedar Park. Professional results with scheduling that works around your business operations.",
    introText: "Hill Country Painting provides commercial interior and exterior painting for Cedar Park businesses — offices, retail spaces, medical and dental offices, restaurants, and multi-family properties. We work after hours, on weekends, and in phases to minimize operational disruption. Serving Avery Ranch, Ranch at Brushy Creek, Buttercup Creek, and all Cedar Park commercial corridors.",
    benefits: [
    "After-hours and weekend scheduling available",
    "Low-VOC and zero-VOC products available",
    "Commercial interiors and exteriors",
    "All Cedar Park commercial areas served",
    ...
    faqs: [
    {
        "question": "Do you do commercial painting in Cedar Park?",
        "answer": "Yes — we serve Cedar Park businesses including offices, retail, medical and dental offices, restaurants, and light industrial spaces. We are experienced with commercial-scale interior and exterior projects and can work around your operational schedule."
    },
    {
        "question": "Can you paint after hours or on weekends in Cedar Park?",
        "answer": "Yes — after-hours and weekend scheduling is standard for our commercial work in Cedar Park. We build your project schedule around your business hours so customers and employees are not disrupted."
    },
    {
        "question": "Do you handle multi-unit or property management painting in Cedar Park?",
        "answer": "Yes — we work with property managers and HOAs for multi-unit residential and commercial properties in Cedar Park. We can coordinate multiple units sequentially, handle common areas and building exteriors, and work within turn schedules."
    },
    {
        "question": "What commercial paint products do you use in Cedar Park?",
    ...
    testimonials: [
    {
        ...
        "rating": 5,
        "text": "Hill Country Painting did an excellent job with our commercial painting project in Cedar Park. Professional, reliable, and the results exceeded our expectations.",
        "initials": "AC"
    },
    {
        "name": "B. Homeowner",
  ...
  images: {
    ...
    secondaryAlt: 'Cedar Park commercial painting excellence'
  }
};
