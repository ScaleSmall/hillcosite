...
const config: ServiceLocationConfig = {
  ...
  location: location,
  content: {
    heroSubtitle: "Professional exterior painting in Leander. UV-resistant coatings, thorough prep, and HOA color approval handled for you.",
    introText: "Exterior painting in Leander demands products and prep methods matched to Central Texas heat, UV intensity, and the specific substrates common in this area — fiber cement, brick veneer, stucco, and wood trim. We serve every Leander neighborhood including Crystal Falls, Travisso, Mason Hills.",
    benefits: [
    ...
    "Covers all Leander neighborhoods",
    ...
    faqs: [
    {
        ...
        "answer": "Exterior painting in Leander typically ranges from $3,500 to $10,000+ depending on home size, number of stories, surface condition, and complexity. We provide detailed written estimates after an in-person assessment."
    },
    {
        "question": "How long does exterior paint last in Leander's climate?",
        "answer": "With premium products and proper prep, exterior paint in Leander should last 8–12 years on most surfaces. Using lower-grade products or skipping prep can cut that to 3–5 years. We always recommend the products that deliver the longest service life."
    },
    {
        "question": "Do you handle HOA color approval for exterior repaints in Leander?",
        "answer": "Yes — for Leander communities that require exterior color approval, we prepare and submit the documentation on your behalf. We aim for first-pass approval by working within each community's approved color parameters."
    },
    {
        "question": "What exterior surfaces do you paint in Leander?",
    ...
    {
        "question": "When is the best time of year for exterior painting in Leander?",
    ...
    testimonials: [
    {
        ...
        "rating": 5,
        "text": "Hill Country Painting did an excellent job with our exterior painting project in Leander. Professional, reliable, and the results exceeded our expectations.",
        "initials": "AC"
    },
    {
        "name": "B. Homeowner",
  ...
  images: {
    ...
    secondaryAlt: 'Leander exterior painting excellence'
  }
};
