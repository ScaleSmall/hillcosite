...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        ...
        "answer": "Full-scope interior painting in North Austin typically starts around $6,000 and often ranges from $6,000 to $10,000+ depending on home size, number of rooms, ceiling height, prep needs, and scope. We provide detailed written estimates after an in-home visit."
    },
    {
