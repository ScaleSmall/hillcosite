...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
      { question: 'How much does cabinet refinishing cost in Tarrytown?', answer: 'Full-scope cabinet refinishing in Tarrytown typically begins around $7,000 and often ranges from $7,000-$14,000 depending on kitchen size, cabinet condition, finish complexity, and historic-home details.' },
