...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        ...
        "answer": "Exterior painting in Georgetown typically ranges from $3,500 to $10,000+ depending on home size, number of stories, surface condition, and complexity. We provide detailed written estimates after an in-person assessment."
    },
    {
