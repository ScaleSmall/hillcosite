...
const config: ServiceLocationConfig = {
  ...
  location: location,
  content: {
    heroSubtitle: "Professional exterior painting in Georgetown. UV-resistant coatings, thorough prep, and HOA color approval handled for you.",
    introText: "Exterior painting in Georgetown demands products and prep methods matched to Central Texas heat, UV intensity, and the specific substrates common in this area — fiber cement, brick veneer, stucco, and wood trim. We serve every Georgetown neighborhood including Sun City Georgetown, Berry Creek, Teravista.",
    benefits: [
    ...
    "Covers all Georgetown neighborhoods",
    ...
    faqs: [
    {
        "question": "How much does exterior painting cost in Georgetown?",
        "answer": "Full-scope exterior painting in Georgetown typically starts around $6,000 and often ranges from $6,000 to $12,000+ depending on home size, number of stories, surface condition, repairs, and complexity. We provide detailed written estimates after an in-person assessment."
    },
    {
        "question": "How long does exterior paint last in Georgetown's climate?",
        "answer": "With premium products and proper prep, exterior paint in Georgetown should last 8–12 years on most surfaces. Using lower-grade products or skipping prep can cut that to 3–5 years. We always recommend the products that deliver the longest service life."
    },
    {
        "question": "Do you handle HOA color approval for exterior repaints in Georgetown?",
        "answer": "Yes — for Georgetown communities that require exterior color approval, we prepare and submit the documentation on your behalf. We aim for first-pass approval by working within each community's approved color parameters."
    },
    {
        "question": "What exterior surfaces do you paint in Georgetown?",
    ...
    {
        "question": "When is the best time of year for exterior painting in Georgetown?",
    ...
    testimonials: [
    {
        ...
        "rating": 5,
        "text": "Hill Country Painting did an excellent job with our exterior painting project in Georgetown. Professional, reliable, and the results exceeded our expectations.",
        "initials": "AC"
    },
    {
        "name": "B. Homeowner",
  ...
  images: {
    ...
    secondaryAlt: 'Georgetown exterior painting excellence'
  }
};
