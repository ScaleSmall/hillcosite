...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        ...
        "answer": "Full-scope exterior painting in Georgetown typically begins around $7,000 and often ranges from $7,000 to $13,000+ depending on home size, number of stories, surface condition, repairs, and complexity. We provide detailed written estimates after an in-person assessment."
    },
    {
