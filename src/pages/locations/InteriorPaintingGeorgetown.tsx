...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        ...
        "answer": "Full-scope interior painting in Georgetown typically begins around $6,500 and often ranges from $6,500 to $10,500+ depending on home size, number of rooms, ceiling height, prep needs, and finish expectations. We provide detailed written estimates after an in-home visit."
    },
    {
