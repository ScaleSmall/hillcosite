...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
      { question: 'How much does exterior painting cost in Northwest Hills?', answer: 'Full-scope Northwest Hills exterior painting typically begins around $7,000 and often ranges from $7,000-$16,000 depending on home size, style, access, repairs, and condition. Mid-century modern homes may require specialized attention.' },
