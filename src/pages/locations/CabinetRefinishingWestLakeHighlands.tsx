...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
      { question: 'How much does cabinet refinishing cost in West Lake Highlands?', answer: 'Full-scope cabinet refinishing in West Lake Highlands typically begins around $7,000 and often ranges from $7,000-$14,000 depending on kitchen size, finish complexity, prep needs, and detail level.' },
