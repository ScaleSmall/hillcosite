...
const config: ServiceLocationConfig = {
  ...
  location: location,
  content: {
    heroSubtitle: "Cabinet refinishing in Georgetown. Factory-quality spray finish on your existing cabinets at a fraction of replacement cost.",
    introText: "Kitchen cabinet refinishing is one of the highest-impact home updates available to Georgetown homeowners — transforming dated or builder-grade cabinets into a fresh, like-new kitchen without the cost and disruption of a full renovation. We serve Sun City Georgetown, Berry Creek, Teravista, and all Georgetown neighborhoods.",
    benefits: [
    ...
    faqs: [
    {
        "question": "How much does cabinet refinishing cost in Georgetown?",
        "answer": "Full-scope cabinet refinishing in Georgetown typically starts around $6,000 and often ranges from $6,000 to $10,500+ depending on the number of cabinet doors, drawer fronts, box painting, prep needs, and finish expectations. We provide exact pricing after measuring your kitchen."
    },
    {
        "question": "How long does cabinet refinishing take in Georgetown?",
        "answer": "Most Georgetown kitchen cabinet projects take 3–5 days including prep, spray application, and curing. We use quick-dry professional products that allow recoating within hours, minimizing the time your kitchen is out of service."
    },
    {
    ...
    {
        "question": "What colors are most popular for cabinet refinishing in Georgetown?",
        "answer": "White and off-white remain the most popular choices in Georgetown — Benjamin Moore Chantilly Lace, Simply White, and Sherwin-Williams Pure White are consistent top picks. Navy and soft blue-gray are popular for islands. We can match virtually any color."
    },
    {
    ...
    testimonials: [
    {
        ...
        "rating": 5,
        "text": "Hill Country Painting did an excellent job with our cabinet refinishing project in Georgetown. Professional, reliable, and the results exceeded our expectations.",
        "initials": "AC"
    },
    {
        "name": "B. Homeowner",
  ...
  images: {
    ...
    secondaryAlt: 'Georgetown cabinet refinishing excellence'
  }
};
