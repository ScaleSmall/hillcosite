...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        ...
        "answer": "Cabinet refinishing in Georgetown typically ranges from $2,500 to $6,500+ depending on the number of cabinet doors, drawer fronts, and whether you include the boxes. We provide exact pricing after measuring your kitchen."
    },
    {
