...
const config: ServiceLocationConfig = {
  ...
  location: location,
  content: {
    heroSubtitle: "Cabinet refinishing in Georgetown. Factory-quality spray finish planned around your existing cabinet layout.",
    ...
    faqs: [
    {
        ...
        "answer": "Full-scope cabinet refinishing in Georgetown typically begins around $6,750 and often ranges from $6,750 to $11,000+ depending on the number of cabinet doors, drawer fronts, box painting, prep needs, and finish expectations. We provide exact pricing after measuring your kitchen."
    },
    {
