...
const config: ServiceLocationConfig = {
  ...
  location: location,
  canonicalOverride: '/interior-painting-hutto',
  content: {
    heroSubtitle: 'Professional interior painting for Hutto homes. From Star Ranch to Brushy Creek, we deliver quality results for your growing family.',
    introText: `Hutto's family-friendly communities deserve interior painting that matches your active lifestyle. Whether you're personalizing a newer home or refreshing an established residence, our team delivers beautiful results efficiently. We understand Hutto families are busy - we work around your schedule and keep disruption to a minimum.`,
    benefits: [
