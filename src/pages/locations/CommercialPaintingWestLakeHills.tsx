...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
      { question: 'How much does commercial painting cost in West Lake Hills?', answer: 'Westlake commercial painting reflects premium standards. Full professional projects typically begin around $8,500 and are priced by scope, access, schedule, substrate condition, and finish requirements after a walkthrough.' },
