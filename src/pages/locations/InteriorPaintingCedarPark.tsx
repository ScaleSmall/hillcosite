...
const config: ServiceLocationConfig = {
  ...
  location: location,
  content: {
    heroSubtitle: 'Transform your Cedar Park home with expert interior painting. From Buttercup Creek to Twin Creeks, we deliver quality results on your family\'s schedule.',
