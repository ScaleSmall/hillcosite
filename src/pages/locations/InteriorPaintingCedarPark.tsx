...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    processSteps: [
      { title: 'Free In-Home Quote', description: 'We visit your Leander home, measure spaces, and discuss your interior painting vision.' },
      { title: 'Color Coordination', description: 'Expert help selecting colors that flow throughout your Leander home\'s open floor plan.' },
    ...
    faqs: [
      { question: 'How much does interior painting cost in Leander?', answer: 'Leander interior painting typically ranges from $3,000-$6,800 depending on home size and scope. Most Leander homes fall in the $4,000-$5,500 range for full interior painting.' },
      { question: 'How quickly can you paint our Leander home?', answer: 'Most Leander interior projects take 2-4 days. We work efficiently to minimize disruption while maintaining quality. We can also work in phases if needed.' },
      ...
      { question: 'Can you work around our kids\' school schedules?', answer: 'Absolutely. Many Leander families prefer we work while kids are at school. We coordinate scheduling to minimize family disruption.' },
      { question: 'What about Leander HOA requirements?', answer: 'While interior painting rarely requires HOA approval, we understand Leander community standards and can advise on colors that complement neighborhood aesthetics.' }
    ],
    testimonials: [
