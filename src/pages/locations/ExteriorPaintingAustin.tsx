...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
      { question: 'How much does exterior painting cost in Austin?', answer: 'Full-scope Austin exterior painting typically begins around $7,000 and often ranges from $7,000-$16,000+ depending on home size, access, repairs, location, and complexity. Historic homes and large properties may exceed this range.' },
