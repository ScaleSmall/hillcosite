...
const config: ServiceLocationConfig = {
  ...
  location: location,
  content: {
    heroSubtitle: "Round Rock's trusted interior painting professionals. Precise, clean, and delivered on time for homes throughout Round Rock.",
    introText: "Round Rock homeowners trust Hill Country Painting for interior projects that go beyond a fresh coat — careful prep, clean lines on trim and ceilings, and color guidance that takes the guesswork out of the process. We serve every neighborhood in Round Rock including Forest Creek, Mayfield Ranch, Brushy Creek.",
    benefits: [
    ...
    faqs: [
    {
        ...
        "answer": "Interior painting in Round Rock typically ranges from $3,000 to $8,000+ depending on home size, number of rooms, and scope. We provide detailed written estimates after an in-home visit."
    },
    {
        "question": "Do you paint ceilings and trim in Round Rock?",
        "answer": "Yes — we offer full interior scope including walls, ceilings, trim, doors, and built-ins. Many Round Rock homeowners choose us for complete interior repaints to ensure consistent color and finish quality throughout."
    },
    {
        "question": "How long does an interior repaint take in Round Rock?",
        "answer": "A full interior repaint for a typical Round Rock home takes 3–5 days depending on size and scope. We work systematically room by room so your family always has usable space during the project."
    },
    {
        "question": "Do you help with paint color selection in Round Rock?",
    ...
    {
        "question": "What paint brands do you use for interior projects in Round Rock?",
    ...
    testimonials: [
    {
        ...
        "rating": 5,
        "text": "Hill Country Painting did an excellent job with our interior painting project in Round Rock. Professional, reliable, and the results exceeded our expectations.",
        "initials": "AC"
    },
    {
        "name": "B. Homeowner",
