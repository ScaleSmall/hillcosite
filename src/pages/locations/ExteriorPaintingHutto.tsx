...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    introText: `Hutto's family-friendly communities deserve exterior painting that lasts. From Star Ranch to Legends of Hutto, our team delivers quality results that enhance curb appeal and protect your investment. We specialize in the newer construction common to Hutto, upgrading builder-grade finishes to premium paints that withstand Texas weather.`,
    benefits: [
    ...
    faqs: [
      ...
      { question: 'Do you work with Hutto HOAs?', answer: 'Yes! We\'re familiar with Star Ranch, Legends of Hutto, and other community requirements. We help select compliant colors and can assist with approval processes.' },
