...
const config: ServiceLocationConfig = {
  ...
  content: {
    ...
    faqs: [
    {
        "question": "How much does cabinet refinishing cost in North Austin?",
        "answer": "Full-scope cabinet refinishing in North Austin typically begins around $6,250 and often ranges from $6,250 to $10,500+ depending on the number of cabinet doors, drawer fronts, box painting, prep needs, and finish expectations. We provide exact pricing after measuring your kitchen."
    },
    {
        "question": "How long does cabinet refinishing take in North Austin?",
        "answer": "Most North Austin kitchen cabinet projects take 3–5 days including prep, spray application, and curing. We use quick-dry professional products that allow recoating within hours, minimizing the time your kitchen is out of service."
    },
    {
    ...
    {
        "question": "What colors are most popular for cabinet refinishing in North Austin?",
        "answer": "White and off-white remain the most popular choices in North Austin — Benjamin Moore Chantilly Lace, Simply White, and Sherwin-Williams Pure White are consistent top picks. Navy and soft blue-gray are popular for islands. We can match virtually any color."
    },
    {
    ...
    testimonials: [
    {
        ...
        "rating": 5,
        "text": "Hill Country Painting did an excellent job with our cabinet refinishing project in North Austin. Professional, reliable, and the results exceeded our expectations.",
        "initials": "AC"
    },
    {
        "name": "B. Homeowner",
...
const CabinetRefinishingNorthAustin = () => <ServiceLocationPage config={config} />;

export default CabinetRefinishingNorthAustin;
