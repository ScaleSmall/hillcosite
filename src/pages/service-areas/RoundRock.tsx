...
const RoundRock = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { icon: Home, title: 'Cabinet Refinishing', description: 'Cabinet refinishing transforms Round Rock kitchens while preserving the existing layout. We spray-apply multiple coats of premium cabinet finish for a result that looks new — popular in homes where the kitchen layout is good but the cabinets look dated.' }
      ...
      <LocalServiceLinks locationName="Round Rock" locationSlug="round-rock" />
