...
const CommercialPainting = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Full professional commercial painting projects in Austin typically begin around $7,500 and are priced by square footage, surface type, access, scheduling needs, business-disruption planning, and finish requirements. We provide a detailed written scope so the number makes sense before work begins.'
    }
  ];
    ...
    <>
      <SEO
        ...
        service={{
          ...
          alternateName: coreServiceLocalSignalKeywords.commercial,
          keywords: coreServiceLocalSignalKeywords.commercial,
          serviceOutput: 'Austin commercial painters service for offices, retail spaces, restaurants, medical suites, property managers, and commercial repaint projects across Greater Austin'
        }}
        faq={faqs}
        product={productData}
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="tel:+15122402246" className="inline-flex items-center justify-center px-8 py-4 bg-brand-azure hover:bg-brand-azureDark text-white font-semibold rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-brand-azure focus:ring-offset-2">
