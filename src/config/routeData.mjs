/**
 * Canonical Route Data - Single Source of Truth
 *
 * This file is the authoritative source for all route definitions.
 * Used by:
 * - src/config/routes.ts (re-exports for TypeScript consumers)
 * - scripts/generate-sitemap.mjs (sitemap generation)
 * - scripts/validate-route-inventory.mjs (route validation)
 */
...
export function getServiceLocationPaths() {
  return serviceLocationPages.map(r => r.path);
}
